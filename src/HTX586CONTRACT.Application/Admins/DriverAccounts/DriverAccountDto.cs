...
public sealed class DriverAccountDto
{
 ...
 public string? DriverLicenseNumber {get;set;} public string? DriverLicenseClass {get;set;} public bool IsActive {get;set;} public bool MustChangePassword {get;set;}

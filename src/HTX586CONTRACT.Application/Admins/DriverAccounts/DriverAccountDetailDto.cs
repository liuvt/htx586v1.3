...
public sealed class DriverAccountDetailDto
{
 ...
 public DateTime? DriverLicenseIssuedDate {get;set;} public DateTime? DriverLicenseExpiryDate {get;set;} public bool IsActive {get;set;} public bool MustChangePassword {get;set;}

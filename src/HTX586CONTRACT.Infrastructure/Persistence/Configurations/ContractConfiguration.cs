...
public sealed class ContractConfiguration : IEntityTypeConfiguration<Contract>
{
    public void Configure(EntityTypeBuilder<Contract> builder)
    {
        ...
        builder.Property(x => x.AssignedByNameSnapshot).HasMaxLength(200);
        ...
        builder.Property(x => x.OperatingDriverName).HasMaxLength(200);
        builder.Property(x => x.OperatingDriverPhoneNumber).HasMaxLength(20);
        builder.Property(x => x.OperatingDriverLicenseNumber).HasMaxLength(50);
        builder.Property(x => x.OperatingDriverLicenseClass).HasMaxLength(20);

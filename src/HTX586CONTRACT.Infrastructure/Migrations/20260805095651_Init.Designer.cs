...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTX586CONTRACT.Domain.Contracts.Contract", b =>
                {
                    ...
                    b.Property<string>("OperatingDriverLicenseClass")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("OperatingDriverLicenseNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("OperatingDriverName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("OperatingDriverPhoneNumber")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("HTX586CONTRACT.Domain.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("VehicleOwnerSignatureFileUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("VehicleOwnerSignatureHash")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<DateTime?>("VehicleOwnerSignedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("HTX586CONTRACT.Domain.Offices.AdminOffice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AdminUserId", "CompanyProfileId")
                        .IsUnique()
                    ...
                    b.ToTable("AdminOffices", (string)null);
                });

            modelBuilder.Entity("HTX586CONTRACT.Domain.Offices.OfficeVehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("VehicleId", "CompanyProfileId")
                        .IsUnique()
                        .HasDatabaseName("UX_OfficeVehicles_Vehicle_Office")
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("OfficeVehicles", (string)null);
                });
            ...
            modelBuilder.Entity("HTX586CONTRACT.Domain.Vehicles.Vehicle", b =>
                {
                    ...
                    b.Property<string>("AccountDriverSignatureFileUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("AccountDriverSignatureHash")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<DateTime?>("AccountDriverSignedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("AccountDriverSignedByUserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HTX586CONTRACT.Domain.Offices.AdminOffice", b =>
                {
                    b.HasOne("HTX586CONTRACT.Domain.Identity.ApplicationUser", "AdminUser")
                        .WithMany("AdminOffices")
            ...
            modelBuilder.Entity("HTX586CONTRACT.Domain.Companies.CompanyProfile", b =>
                {
                    b.Navigation("AdminOffices");

                    b.Navigation("Contracts");

                    b.Navigation("OfficeVehicles");
                });

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleOwnerSignatureFileUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    VehicleOwnerSignatureHash = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    VehicleOwnerSignedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountDriverSignatureFileUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AccountDriverSignatureHash = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    AccountDriverSignedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AccountDriverSignedByUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSelfCreated = table.Column<bool>(type: "bit", nullable: false),
                    AssignedByUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    AssignedByNameSnapshot = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    CustomerTravelsWithGroup = table.Column<bool>(type: "bit", nullable: false),
                    OperatingDriverName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    OperatingDriverPhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    OperatingDriverLicenseNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OperatingDriverLicenseClass = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
